    ...
    return (
        <Box className={classes.MainLayout}>
            ...
            <Box className={classes.DetailBox}>
                ...
                <Typography className={classes.PageGroupTitle}>If the address isn’t working, you can refresh both the address and the QR with the refresh button. The amount may take a while to appear in your balance since all transactions can take hours to be confirmed by the blockchain. Learn more about depositing with Cash App.</Typography>
            </Box>
        </Box>
    );
};
