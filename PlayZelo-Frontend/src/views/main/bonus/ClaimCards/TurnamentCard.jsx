...
import CardIcon from "assets/icons/Tournaments.png";
...
const TournamentCard = ({ locked = false }) => {
    const classes = useStyles();

    return (
        <Box className={clsx(classes.CardLayout, locked ? classes.LockedCard : '')}>
            <Box className={classes.CardTitleBox}>
                <img src={CardIcon} alt="icon" width="39px" height="34px" />
                <span className={classes.CardTitle}>Tournament</span>
            </Box>
