...
import CardIcon from "assets/icons/giveaway.png";
...
const GivewayCard = ({ locked = false }) => {
    const classes = useStyles();

    return (
        <Box className={clsx(classes.CardLayout, locked ? classes.LockedCard : '')}>
            <Box className={classes.CardTitleBox}>
                <img src={CardIcon} alt="icon" width="53px" height="41px" />
                <span className={classes.CardTitle}>Giveaway</span>
            </Box>
