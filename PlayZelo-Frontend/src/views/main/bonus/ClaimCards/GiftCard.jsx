...
import CardIcon from "assets/icons/gift.png";
...
const GiftCard = ({ locked = false }) => {
    const classes = useStyles();

    return (
        <Box className={clsx(classes.CardLayout, locked ? classes.LockedCard : '')}>
            <Box className={classes.CardTitleBox}>
                <img src={CardIcon} alt="icon" width="46px" height="43px" />
                <span className={classes.CardTitle}>Gift</span>
            </Box>
